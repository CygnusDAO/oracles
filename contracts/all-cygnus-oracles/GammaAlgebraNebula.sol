...
import {IAlgebraPoolState} from "./interfaces/Gamma/IAlgebraPoolState.sol";
 ...
 *  @notice Implementation of fair lp token pricing using Chainlink price feeds for Algebra Pools
 *          https://github.com/makerdao/univ3-lp-oracle/blob/master/src/GUniLPOracle.sol
 */
contract GammaAlgebraNebula is ICygnusNebula {
    /*  ═══════════════════════════════════════════════════════════════════════════════════════════════════════ 
            1. LIBRARIES
        ═══════════════════════════════════════════════════════════════════════════════════════════════════════  */
     ...
     *  @inheritdoc ICygnusNebula
     */
    string public override name = "Cygnus: Hypervisor Algebra Nebula";
